...
void func_15010FB0(void) {
    D_800BE4F0 = func_10003C40(16, 1, 0, 0);
    D_800BE4F0->unk0 = func_15195AA8(D_800B0E04, D_80090310, 1, -1, 0, 1, 0, 0);
    D_800BE4F0->unk4 = func_15195AA8(D_800B0E00, D_80090314, 0, -1, 0, 0, 0, 0);
