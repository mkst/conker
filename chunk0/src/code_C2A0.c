...
#pragma GLOBAL_ASM("asm/nonmatchings/code_C2A0/func_8500C2F0.s")
#pragma GLOBAL_ASM("asm/nonmatchings/code_C2A0/func_8500C8D0.s")
#pragma GLOBAL_ASM("asm/nonmatchings/code_C2A0/func_8500CE4C.s")

#pragma GLOBAL_ASM("asm/nonmatchings/code_C2A0/func_8500D3AC.s")
// void func_8500D3AC(s32 arg0, f32 arg1) {
//
//     f32 temp_f0;
//     struct171 tmp;
//     f32 temp_f12;
...
//
//
//     phi_f30 = func_8514462C(arg0) * arg1 * D_8009616C;
//
//     if (phi_f30 > 1.0f) {
//         tmp.unk8 = 1.0f;
//         tmp.unkC = 1.0f;
...
//
//         do {
//             func_85008340(arg0, &tmp.unk30, &tmp.unk38, &tmp.unk4, &tmp.unk0);
//             phi_f18 = (u16) (func_80024770() * func_850ADA20());
...
//
//             func_8510F800(0);
//             tmp.unk64 = func_8510FD20(tmp.unk30, tmp.unk38);
//             func_85132A4C(&tmp, 3, 0xFF, 0, 0xFF, 1);
//
//         } while ((phi_f30 -= 1.0f) > 1.0f);
//     }
// }

#pragma GLOBAL_ASM("asm/nonmatchings/code_C2A0/func_8500D8C8.s")

#pragma GLOBAL_ASM("asm/nonmatchings/code_C2A0/func_8500DE88.s")
// NON-MATCHING: not a bad start..
// void func_8500DE88(s32 arg0, f32 arg1) {
//
//     f32 temp_f0;    // tmp
//     f32 phi_f10;    // tmp
...
//
//
//     f32 phi_f24 = func_8514462C(arg0) * arg1 * D_800961A8;
//
//     if (phi_f24 > 1.0f) {
//         tmp.unk48 = 20739;
//         tmp.unk40 = 0x200005;
...
//
//         do {
//             phi_f10 = (u16) (func_80024770() * func_850ADA20()) ;
//
//             tmp.unk68 = tmp.unk6C = tmp.unk24 = (phi_f10 * temp_f22 * 600.0f) + 200.0f;
//
//             tmp.unk5B = (func_80024770() * func_850ADA20()) % 0x47U + 0x32;
//             tmp.unk2A = (func_80024770() * func_850ADA20()) % 3U;
//             tmp.unk2B = (func_80024770() * func_850ADA20()) % 3U;
//
//             phi_f10 = (u16) (func_80024770() * func_850ADA20());
...
//             tmp.unk58 = ((func_80024770() * func_850ADA20()) % 0x38U) + 0x50;
//             tmp.unk54 = ((func_80024770() * func_850ADA20()) % 0x2EU) + 0xB4;
//             func_85008340(arg0, &tmp.unk70, &tmp.unk78, &tmp.unk1C, &tmp.unk18);
//
//             phi_f10 = (u16) (func_80024770() * func_850ADA20());
//
...
//             func_8510F800(0);
//             tmp.unk9C = func_8510FD20(tmp.unk70, tmp.unk78);
//             temp_v0 = func_85130280(&tmp.unk40, 2, 0, 28, 255, 1);
//             if (temp_v0 != NULL) {
//                 func_80022EC0(&temp_v0->unkA8, &tmp.unk24, 28); // memcpy  temp_v0->A8 ?
//             }
//             phi_f24 -= 1.0f;
//         }
//         while (phi_f24 > 1.0f);
