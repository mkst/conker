...
void func_1506160C(s32, s32, u8, u8, s32);
...
void func_1506B14C(void) {
    func_1505E650(D_800D154C, D_800D154C->unk84.h.unk0 + 1, D_800D154C->unk4C, 3.0f, 0.0f, 0.0f, 0);
}

void func_1506B198(void) {
    func_1505E650(D_800D154C, D_800D154C->unk84.h.unk0 + 1, D_800D154C->unk4C, 3.0f, 0.0f, 0.0f, 1);
}
...
//     temp_t0 = (temp_a1_2->unk7A + (temp_a1_2->unk1FD << 8)) - func_1505A630(D_800CC2D0[0].unk14 - temp_a1->unk14, temp_a1->unk1C - D_800CC2D0[0].unk1C, temp_a1, 0);
...
//         func_1506E8D8();
//         D_800D154C->unk3C = (f32) (D_800D154C->unk3C * D_80099C38);
//     }
// }
...
void func_1506B740(void) {
    ...
    if ((D_80099C3C != D_800D154C->unk118) && (D_800D154C->unk18 < D_800D154C->unk118)) {
        D_800D154C->unk31C->unkE = 0x2D0;
    } else {
        if (D_800D154C->unk84.h.unk0 == 0xA7) {
...
//     *temp_v0 = (*temp_v0 | 0x4000);
//     temp_a0 = D_800D154C->unk31C;
//     if (temp_a0 != 0) {
//         temp_a0->unk78 = 0;
//         temp_v0_2 = D_800D1940;
//         temp_v1 = &D_800D2E60[((s32) temp_v0_2 >> 3)];
//         *temp_v1 = (*temp_v1 | (1 << (temp_v0_2 & 7)));
//     }
...
void func_1506BDE8(void) {
    if (D_800D154C->unk18 < D_80099C40) {
        D_800D154C->unk20 = (f32) D_800D1580;
    }
}

void func_1506BE2C(void) {
    D_800D154C->unk24 = (f32) D_800D1580;
}

void func_1506BE54(void) {
    D_800D154C->unk24 = (f32) ((f32) D_800D1580 * D_80099C44);
}
...
void func_1506BE98(void) {
    D_800D154C->unkC0 = D_800D1580;
}

void func_1506BEC0(void) {
    D_800D154C->unk89 = (s8) D_800D1580;
}
...
void func_1506BF1C(void) {
    if (D_800D154C->unk118 <= D_800D154C->unk18) {
        func_1506BF5C();
    }
}
...
//             phi_f0 = D_800D154C->unk318->unk780 - 15.0f;
//         }
...
//         D_800D2104[temp_s0->unk13F]->unk8 = (s16) (s32) (D_800D154C->unk14 + sp40);
//         D_800D2104[temp_s0->unk13F]->unkC = (s16) (s32) (D_800D154C->unk1C + sp3C);
//         D_800D2104[temp_s0->unk13F]->unkA = (s16) (s32) (D_800D154C->unk18 + sp38);
//         temp_s0->unk65 = (u8)0;
//         temp_s0->unk218 = 0;
//         if ((D_800D1580 & 0xFF00) != 0) {
//             temp_s0->unk232 = (u8)4;
...
//             temp_s0->unk18 = (f32) (D_800D154C->unk18 + 70.0f);
//         } else {
//             temp_s0->unk232 = (u8)2;
//             temp_s0->unk3C = -15.0f;
//             temp_s0->unk20 = 34.0f;
...
void func_1506D4F4(void) {
    func_1505E650(D_800D154C, D_800D154C->unk84.h.unk0, 0.009999999776482582f, 0.0f, 0.0f, 0.0f, 0);
}
...
void func_1506DA78(void) {
    D_800D154C->unk125 = D_800D1580;
}

void func_1506DA94(void) {
    if (D_800D1580 != 0) {
        if ((D_800D154C->unk44 > 20.0f) && (D_800D154C->unk3C > 20.0f)) {
            D_800D154C->unk83 = (u8)0;
        }
    }
...
void func_1506DB5C(void) {
    D_800D154C->unk3C = (f32) D_800D1580;
}
...
//     D_800D154C->unk1E5 = (u8)D_800D1580;
//     D_800D154C->unk1E6 = (D_800D1580 >> 8);
// }
...
void func_1506DCDC(void) {
    D_800D154C->unk1CA = (s8) D_800D1580;
}
...
//     temp_v0 = D_800D1580;
//     if (temp_v0 == 0) {
//         temp_v1 = D_800D154C.unk0;
//         temp_v1->unkF8 = (s32) temp_v1->unk144->unk18;
//         return temp_v0;
//     }
//     temp_v1_2 = D_800D154C.unk154C;
//     temp_v1_2->unkF8 = (s32) (temp_v1_2->unkF8 | temp_v0);
//     return temp_v0;
// }
...
void func_1506DD6C(void) {
    if (D_800D154C->unk31C != 0) {
        D_800D154C->unk31C->unk7D = (s8) (D_800D1580 & 0x7F);
    }
    if (D_800D1580 == 0) {
        D_800D154C->unk76 = (u16) D_800D154C->unk7A;
    }
}
...
//             if (temp_a1->unk4 == 0x20) {
//                 temp_a1->unk20 = 0.0f;
//                 temp_a1->unkF8 |= 0x200;
//                 temp_a1->unk24 = 0.0f;
//                 temp_a1->unk3C = 0.0f;
//             }
//             temp_a1->unk104 = (u8)0xFE;
//             temp_a1->unk105 = (u8)0;
//             sp18 = temp_a1;
//             sp27 = temp_t6;
...
// NON-MATCHING: JUSTREG: almost there
...
//
//     tmp0 = D_800D154C;
//     temp_v0 = (tmp0->unk13C - 100) & 0xff;
//
//     if (tmp0->unk13C) {
//         tmp1 = &D_800CC2D0[temp_v0];
//         if ((s32) tmp1->unk13D >= 0x64) {
//             tmp1->unk65 = 0;
//             tmp1->unk13D = (u8)0U;
//             tmp1->unk3C = 0.0f;
//             tmp1->unk20 = 0.0f;
//             tmp1->unk24 = 6.0f;
//             tmp1->unk1CC = D_80099DA4; // 1000000.0
//         }
//         tmp0->unk13C = 0U;
//     }
// }
...
void func_1506EC50(void) {
    if (D_80099DA8 < D_800D154C->unk28) {
        if (((D_800D1580 & 0x8000) == 0) || (D_800CC2E8[0] < D_800D154C->unk18)) {
...
//     func_150E2EA4(D_800D154C, D_800D154C->unk3B, 0x14, -1, 482.0f, -127.0f, -45.0f, D_80099E98, -211.0f, -114.0f, 3, 3, 5, 20.0f, (func_150ADA68() * 10.0f) + 40.0f, 0, 0.0f);
// }

#pragma GLOBAL_ASM("asm/nonmatchings/code_6AD30/func_1506F9C0.s")
// void func_1506F9C0(s32 arg0) {
//     func_150E2EA4(D_800D154C, D_800D154C->unk3B, 0x14, -1, 241.0f, -127.0f, -45.0f, 418.0f, -211.0f, -114.0f, 3, 3, 5, 20.0f, (func_150ADA68() * 10.0f) + 40.0f, 0, 0.0f);
// }

#pragma GLOBAL_ASM("asm/nonmatchings/code_6AD30/func_1506FA90.s")
// void func_1506FA90(s32 arg0) {
//     func_150E2EA4(D_800D154C, D_800D154C->unk3B, 0x1A, -1, -181.0f, -218.0f, -1.0f, D_80099E9C, -584.0f, -2.0f, 3, 3, 5, 20.0f, (func_150ADA68() * 10.0f) + 40.0f, 0, 0.0f);
// }
...
//     tmp.unk0 = temp_a1->unk14;
//     tmp.unk4 = temp_a1->unk18;
//     tmp.unk8 = temp_a1->unk1C;
//
//     if (temp_a1->unk124) {
...
void func_15071278(s32 arg0) {
    func_150FC438(D_800D154C, 0, 1, D_800D154C->unk84.b.unk1);
}
...
void func_150716EC(s32 arg0) {
    ...
    temp_v0 = D_800D154C;
    tmp.unk0 = temp_v0->unk14;
    tmp.unk4 = temp_v0->unk18;
    tmp.unk8 = temp_v0->unk1C;
...
// NON-MATCHING: JUSTREG: uses v0 not t0
...
//     if (temp_v0 != 0) {
//         tmp0 = (D_800D1580 >> 8);
//         func_1506160C(temp_v0, 2, tmp0, D_800D1580, 0);
//     }
// }
...
//     temp_v1->unk5C = temp_v0 >> 16;
//     temp_v1->unk101 = 4;
// }

void func_150727AC(void) {
    D_800D154C->unk4C = D_800D1580 * D_80099F4C;
    D_800D154C->unk2D0->unk10 = D_800D154C->unk4C;
}
...
void func_15072AF8(void) {
    func_1505E650(D_800D154C, D_800D154C->unk84.h.unk0 + 1, 1.0f, 6.0f, 0.0f, 0.0f, 0);
}
...
void func_15072EF4(void) {
    D_800D154C->unk104 = (s8) D_800D1580;
}
...
//
//     if (D_800D1580 == 1) {
//         temp_v0 = D_800D154C.unk0;
//         temp_v0->unk2F8 = (u16) (temp_v0->unk2F8 | 0x100);
//         return temp_v0;
//     }
//     temp_v0_2 = D_800D154C.unk154C;
//     temp_v0_2->unk2F8 = (u16) (temp_v0_2->unk2F8 & 0xFEFF);
//     return temp_v0_2;
// }
...
// NON-MATCHING: JUSTREG: uses v0 not v1
// void func_1507490C(void) {
//     struct127 *tmp;
//     s32 temp_v0 = D_800D154C->unk13C - 100;
//
//     if (temp_v0 != 0) {
//         tmp = &D_800CC2D0[temp_v0 & 0xFF];
//         if (tmp->unk13D >= 0x64) {
//             tmp->unk232 = D_800D1580;
//             tmp->unk218 = 0;
//             tmp->unk104 = 0;
//         }
//     }
...
//         } else {
//             phi_f2 = ((D_800D154C->unk148 - D_8009A0F4) * ((temp_f0 - 200.0f) / D_8009A0F8)) + D_8009A0F4;
//         }
//     }
...
void func_150750C4(struct127 *arg0, struct127 *arg1, u8 *arg2) {
    ...
    if ((arg1->unk4 == 0x88) && ((s32) arg0->unk107 < 0x37)) {
        arg0->unk138 += 3;
    }
