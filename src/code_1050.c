...
void func_10001050(void) {
    ...
    osCreateThread(&D_800318B0, 1, func_100010F8, 0, &D_8002D8B0, 5);
    osStartThread(&D_800318B0);
}

void func_100010F8(s32 arg0) {
    func_10004470(); // create message queues
    osCreateThread(&D_80031AE0, 3, func_10001194, arg0, &D_800318B0, 10);
...
//     func_10003BD0();
//     func_1000709C();
//     D_8002AAE8.unk0 = func_10003C6C(126144, 0xFF, 3, 1, 0);
//     D_8002AAE8.unk4 = func_10003C6C(126144, 0xFF, 3, 1, 0);
