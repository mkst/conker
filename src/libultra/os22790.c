...
loop_1:
    ...
    if (func_80026750(0x1FC007FC, sp3C | 8) != 0) {
loop_3:
        if (func_80026750(0x1FC007FC, sp3C | 8) != 0) {
            goto loop_3;
        }
    ...
    *(void *)0x8000000C = (s32) (void *)0x100071D0->unkC;
    ...
    temp_ret = func_80026968(*(void *)0x8002BD10, *(void *)0x8002BD14, 0, 3);
    temp_v1 = (u32) (u64) temp_ret;
    sp20 = temp_ret;
    sp24 = temp_v1;
    temp_ret_2 = func_80026868(sp20, sp24, 0, 4);
